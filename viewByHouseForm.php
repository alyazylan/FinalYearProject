...
<html lang="en">
<head>
<title>View Residents by House Form</title>
<meta charset="utf-8">
...
<center>
	<form name="form1" method="post" action="viewByHouse.php">
		<input name="txtSearch" type="text" id="txtSearch" placeholder="INSERT RESIDENT'S HOUSE NUMBER" size="45" required>
